...
const Page = (props:PageProps<results>) =>{
    ...
    return <div><h1>Numero {id} Personaje {name}</h1> <h2>Especie : {species}</h2> <h2>Localizacion : {location}</h2> <h2>Status <text style={stat}>{status}</text> <p>Imagen</p> <img src={image}></img> </h2></div>
}
